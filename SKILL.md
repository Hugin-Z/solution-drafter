...
- **操作**：3 步 docx 装配（见下）+ 用户多轮迭代修订 markdown 字面。
...
3. 调 `from docx_builder import create_section_doc; create_section_doc(Path('templates/<new_doc_type>/template.docx'))` 生成空 docx 模板。
